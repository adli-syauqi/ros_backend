...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='Output path for the coverage waypoints YAML file'
        ),
        Node(
            ...
            parameters=[{
                ...
                "global_frame": "map",
                "min_wp_dist": 0.5,       # double <!-- The maximum distance between waypoints before a split can be considered --> default - "4.5"
